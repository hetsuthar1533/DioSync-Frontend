...
import { GetSubscriptionInquiries } from '../../../../services/inquiryService'
import { VIEW } from '../../../../constants/roleConstants'
import ViewSubscriptionInquiry from './ViewSubscriptionInquiry'
...
function SubscriptionInquiry() {
  ...
  const getSubscriptionData = async () => {
    ...
    const response = await GetSubscriptionInquiries(queryString)
